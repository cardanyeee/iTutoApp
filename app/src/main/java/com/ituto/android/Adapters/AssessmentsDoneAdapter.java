...
public class AssessmentsDoneAdapter extends RecyclerView.Adapter<AssessmentsDoneAdapter.AssessmentHolder> {
    ...
    public AssessmentsDoneAdapter(Context context, ArrayList<Assessment> assessmentArrayList, AssessmentsDoneAdapter.OnItemListener onItemListener) {
    ...
    @NonNull
    @Override
    public AssessmentsDoneAdapter.AssessmentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_assessment, parent, false);
        return new AssessmentsDoneAdapter.AssessmentHolder(view, onItemListener);
    }

    @Override
    public void onBindViewHolder(@NonNull AssessmentsDoneAdapter.AssessmentHolder holder, int position) {
